...
exports.rediregis = () => {
	return`*「 SUDAH TERDAFTAR 」*\n\n*Kamu sudah terdaftar di database Castle roboX*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner Arifiツ, Laporan palsu atau main² tidak akan ditanggapi.*`
}
